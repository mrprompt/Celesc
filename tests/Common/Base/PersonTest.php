...
class PersonTest extends TestCase
{
    ...
    /**
     * @test
     * @covers \MrPrompt\Celesc\Common\Base\Person::__construct()
     * @covers \MrPrompt\Celesc\Common\Base\Person::getDocument()
     */
     ...
     * @test
     * @covers \MrPrompt\Celesc\Common\Base\Person::__construct()
     * @covers \MrPrompt\Celesc\Common\Base\Person::setDocument()
     */
     ...
     * @test
     * @covers \MrPrompt\Celesc\Common\Base\Person::__construct()
     * @covers \MrPrompt\Celesc\Common\Base\Person::getHomePhone()
     */
     ...
     * @test
     * @covers \MrPrompt\Celesc\Common\Base\Person::__construct()
     * @covers \MrPrompt\Celesc\Common\Base\Person::setHomePhone()
     */
     ...
     * @test
     * @covers \MrPrompt\Celesc\Common\Base\Person::__construct()
     * @covers \MrPrompt\Celesc\Common\Base\Person::getHomePhoneSecondary()
     */
     ...
     * @test
     * @covers \MrPrompt\Celesc\Common\Base\Person::__construct()
     * @covers \MrPrompt\Celesc\Common\Base\Person::setHomePhoneSecondary()
     */
     ...
     * @test
     * @covers \MrPrompt\Celesc\Common\Base\Person::__construct()
     * @covers \MrPrompt\Celesc\Common\Base\Person::getName()
     */
     ...
     * @test
     * @covers \MrPrompt\Celesc\Common\Base\Person::__construct()
     * @covers \MrPrompt\Celesc\Common\Base\Person::setName()
     */
     ...
     * @test
     * @covers \MrPrompt\Celesc\Common\Base\Person::__construct()
     * @covers \MrPrompt\Celesc\Common\Base\Person::getEmail()
     */
     ...
     * @test
     * @covers \MrPrompt\Celesc\Common\Base\Person::__construct()
     * @covers \MrPrompt\Celesc\Common\Base\Person::setEmail()
     */
    ...
    /**
     * @test
     * @covers \MrPrompt\Celesc\Common\Base\Person::getCellPhone()
     */
     ...
     * @test
     * @covers \MrPrompt\Celesc\Common\Base\Person::__construct()
     * @covers \MrPrompt\Celesc\Common\Base\Person::setCellPhone()
     */
     ...
     * @test
     * @covers \MrPrompt\Celesc\Common\Base\Person::__construct()
     * @covers \MrPrompt\Celesc\Common\Base\Person::getFatherName()
     */
     ...
     * @test
     * @covers \MrPrompt\Celesc\Common\Base\Person::__construct()
     * @covers \MrPrompt\Celesc\Common\Base\Person::setFatherName()
     */
     ...
     * @test
     * @covers \MrPrompt\Celesc\Common\Base\Person::__construct()
     * @covers \MrPrompt\Celesc\Common\Base\Person::getMotherName()
     */
     ...
     * @test
     * @covers \MrPrompt\Celesc\Common\Base\Person::__construct()
     * @covers \MrPrompt\Celesc\Common\Base\Person::setMotherName()
     */
     ...
     * @test
     * @covers \MrPrompt\Celesc\Common\Base\Person::__construct()
     * @covers \MrPrompt\Celesc\Common\Base\Person::getPerson()
     */
     ...
     * @test
     * @covers \MrPrompt\Celesc\Common\Base\Person::__construct()
     * @covers \MrPrompt\Celesc\Common\Base\Person::setPerson()
     */
     ...
     * @test
     * @covers \MrPrompt\Celesc\Common\Base\Person::__construct()
     * @covers \MrPrompt\Celesc\Common\Base\Person::getSalaried()
     */
     ...
     * @test
     * @covers \MrPrompt\Celesc\Common\Base\Person::__construct()
     * @covers \MrPrompt\Celesc\Common\Base\Person::setSalaried()
     */
     ...
     * @test
     * @covers \MrPrompt\Celesc\Common\Base\Person::__construct()
     * @covers \MrPrompt\Celesc\Common\Base\Person::getBirth()
     */
     ...
     * @test
     * @covers \MrPrompt\Celesc\Common\Base\Person::__construct()
     * @covers \MrPrompt\Celesc\Common\Base\Person::setBirth()
     */
     ...
     * @test
     * @covers \MrPrompt\Celesc\Common\Base\Person::__construct()
     * @covers \MrPrompt\Celesc\Common\Base\Person::getAddress()
     */
     ...
     * @test
     * @covers \MrPrompt\Celesc\Common\Base\Person::__construct()
     * @covers \MrPrompt\Celesc\Common\Base\Person::setAddress()
     */
