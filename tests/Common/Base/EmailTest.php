...
class EmailTest extends TestCase
{
    ...
    /**
     * @test
     * @covers \MrPrompt\Celesc\Common\Base\Email::__construct()
     * @covers \MrPrompt\Celesc\Common\Base\Email::getAddress()
     */
     ...
     * @test
     * @covers \MrPrompt\Celesc\Common\Base\Email::__construct()
     * @covers \MrPrompt\Celesc\Common\Base\Email::setAddress()
     */
     ...
     * @test
     * @covers \MrPrompt\Celesc\Common\Base\Email::__construct()
     * @covers \MrPrompt\Celesc\Common\Base\Email::getPrimary()
     */
     ...
     * @test
     * @covers \MrPrompt\Celesc\Common\Base\Email::__construct()
     * @covers \MrPrompt\Celesc\Common\Base\Email::isPrimary()
     */
     ...
     * @test
     * @covers \MrPrompt\Celesc\Common\Base\Email::__construct()
     * @covers \MrPrompt\Celesc\Common\Base\Email::setPrimary()
     */
