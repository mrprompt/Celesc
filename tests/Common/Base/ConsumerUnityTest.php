...
class ConsumerUnityTest extends TestCase
{
    ...
    /**
     * @test
     * @covers \MrPrompt\Celesc\Common\Base\ConsumerUnity::__construct()
     * @covers \MrPrompt\Celesc\Common\Base\ConsumerUnity::getNumber()
     */
     ...
     * @test
     * @covers \MrPrompt\Celesc\Common\Base\ConsumerUnity::__construct()
     * @covers \MrPrompt\Celesc\Common\Base\ConsumerUnity::setNumber()
     */
     ...
     * @test
     * @covers \MrPrompt\Celesc\Common\Base\ConsumerUnity::__construct()
     * @covers \MrPrompt\Celesc\Common\Base\ConsumerUnity::getRead()
     */
     ...
     * @test
     * @covers \MrPrompt\Celesc\Common\Base\ConsumerUnity::__construct()
     * @covers \MrPrompt\Celesc\Common\Base\ConsumerUnity::setRead()
     */
     ...
     * @test
     * @covers \MrPrompt\Celesc\Common\Base\ConsumerUnity::__construct()
     * @covers \MrPrompt\Celesc\Common\Base\ConsumerUnity::getMaturity()
     */
     ...
     * @test
     * @covers \MrPrompt\Celesc\Common\Base\ConsumerUnity::__construct()
     * @covers \MrPrompt\Celesc\Common\Base\ConsumerUnity::setMaturity()
     */
     ...
     * @test
     * @covers \MrPrompt\Celesc\Common\Base\Consumerunity::__construct()
     * @covers \MrPrompt\Celesc\Common\Base\Consumerunity::getCode()
     */
     ...
     * @test
     * @covers \MrPrompt\Celesc\Common\Base\Consumerunity::__construct()
     * @covers \MrPrompt\Celesc\Common\Base\Consumerunity::setCode()
     * @covers \MrPrompt\Celesc\Common\Base\Consumerunity::getCode()
     */
     ...
     * @expectedException InvalidArgumentException
     */
    public function setCodeCouldNotBeEmpty()
    {
        $this->unity->setCode('');
    }
}
