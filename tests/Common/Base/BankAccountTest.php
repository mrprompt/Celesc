...
class BankAccountTest extends TestCase
{
    ...
    /**
     * @test
     * @covers \MrPrompt\Celesc\Common\Base\BankAccount::__construct()
     * @covers \MrPrompt\Celesc\Common\Base\BankAccount::getNumber()
     */
     ...
     * @test
     * @covers \MrPrompt\Celesc\Common\Base\BankAccount::__construct()
     * @covers \MrPrompt\Celesc\Common\Base\BankAccount::getDigit()
     */
     ...
     * @test
     * @covers \MrPrompt\Celesc\Common\Base\BankAccount::__construct()
     * @covers \MrPrompt\Celesc\Common\Base\BankAccount::getOperation()
     */
     ...
     * @test
     * @covers \MrPrompt\Celesc\Common\Base\BankAccount::__construct()
     * @covers \MrPrompt\Celesc\Common\Base\BankAccount::getBank()
     */
     ...
     * @test
     * @covers \MrPrompt\Celesc\Common\Base\BankAccount::__construct()
     * @covers \MrPrompt\Celesc\Common\Base\BankAccount::getSecurity()
     */
     ...
     * @test
     * @covers \MrPrompt\Celesc\Common\Base\BankAccount::__construct()
     * @covers \MrPrompt\Celesc\Common\Base\BankAccount::getHolder()
     */
     ...
     * @test
     * @covers \MrPrompt\Celesc\Common\Base\BankAccount::__construct()
     * @covers \MrPrompt\Celesc\Common\Base\BankAccount::setNumber()
     */
     ...
     * @test
     * @covers \MrPrompt\Celesc\Common\Base\BankAccount::__construct()
     * @covers \MrPrompt\Celesc\Common\Base\BankAccount::setDigit()
     */
     ...
     * @test
     * @covers \MrPrompt\Celesc\Common\Base\BankAccount::__construct()
     * @covers \MrPrompt\Celesc\Common\Base\BankAccount::setOperation()
     */
     ...
     * @test
     * @covers \MrPrompt\Celesc\Common\Base\BankAccount::__construct()
     * @covers \MrPrompt\Celesc\Common\Base\BankAccount::setSecurity()
     */
     ...
     * @test
     * @covers \MrPrompt\Celesc\Common\Base\BankAccount::__construct()
     * @covers \MrPrompt\Celesc\Common\Base\BankAccount::setBank()
     */
     ...
     * @test
     * @covers \MrPrompt\Celesc\Common\Base\BankAccount::__construct()
     * @covers \MrPrompt\Celesc\Common\Base\BankAccount::setHolder()
     */
