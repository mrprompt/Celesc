...
class PhoneTest extends TestCase
{
    ...
    /**
     * @test
     * @covers \MrPrompt\Celesc\Common\Base\Phone::__construct()
     * @covers \MrPrompt\Celesc\Common\Base\Phone::getNumber()
     */
     ...
     * @test
     * @covers \MrPrompt\Celesc\Common\Base\Phone::__construct()
     * @covers \MrPrompt\Celesc\Common\Base\Phone::setNumber()
     */
     ...
     * @test
     * @covers \MrPrompt\Celesc\Common\Base\Phone::__construct()
     * @covers \MrPrompt\Celesc\Common\Base\Phone::getType()
     */
     ...
     * @test
     * @covers \MrPrompt\Celesc\Common\Base\Phone::__construct()
     * @covers \MrPrompt\Celesc\Common\Base\Phone::setType()
     */
